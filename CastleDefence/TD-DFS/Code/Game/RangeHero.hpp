...
public:
	...
	float m_attackAnimationTimer = 1.f;
	...
	RangeHero( Game* game , Vec2 position , Faction faction = FACTION_GOOD,Lanes lane= LANE1_1, Upgrade upgrade=UPGRADE_NONE );
