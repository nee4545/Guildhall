...
Spike::Spike( Game* game , Vec2 position , Faction faction /*= FACTION_GOOD */ ) :Entity( game , position )
{
	m_faction = faction;
...
void Spike::Render()
{
	...
	Texture* tex = g_theRenderer->GetOrCreateTextureFromFile( "Data/Images/Spike.png" );
