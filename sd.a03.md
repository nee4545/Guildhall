...
- [x] *X03.06 : 05pts*: Text Selection (Use mouse: LMB to drag text)
...
- [-] *X03.22 : 02pts*: Mouse Input on Dev Console (scroll wheel to scroll, click to set carrot)(only set carrot done)
- [x] *X03.23 : 04pts*: Mouse Selection (Requires X03.05 and X03.22)(can select text using mouse, delete multiple text in one go)
- [-] *X03.24 : 02pts*: Navigation Hotkeys, Home, End, Ctrl + Arrows (Home and End only supported)
- [x] *X03.25 : 02pts*: Audio Cues (Sound for Good Command, Bad Command, Console Open, and maybe keypress... though may get annoying)(added audio for good and bad commands)
